<?php
  if (isset($_POST['class_1'])) {
    $sql_differenz="`klasse`='1',";
  }
  if (isset($_POST['class_2'])) {
    $sql_differenz="`klasse`='2',";
  }
  if (isset($_POST['class_3'])) {
    $sql_differenz="`klasse`='3',";
  }
  if (isset($sql_differenz)) {
    ...
    if ($_SESSION['class']==1) {
      skill_change($_SESSION['userID'], 2, 1, 1);
    }
    if ($_SESSION['class']==2) {
      skill_change($_SESSION['userID'], 3, 1, 1);
    }
    if ($_SESSION['class']==3) {
      skill_change($_SESSION['userID'], 4, 1, 1);
    }
    skill_change($_SESSION['userID'], 5, 1, 1);
