...
?>
    ...
    <a href="index.php?site=account"><?php echo text_ausgabe("NAVIGATION", 2, $bg['sprache']); ?></a><br>
    <a href="index.php?site=charakter"><?php echo text_ausgabe("NAVIGATION", 9, $bg['sprache']); ?></a><br>		
